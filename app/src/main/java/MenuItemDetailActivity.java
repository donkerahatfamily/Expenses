package com.example.necibeahat.expenses;
...
import com.example.necibeahat.expenses.R;
...
public class MenuItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(MenuItemDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(MenuItemDetailFragment.ARG_ITEM_ID));
